...
def get_parameters():
    ...
    parser.add_argument('--dataset', type=str, default='iclevr', choices=['lsun', 'celeb'])
    parser.add_argument('--use_tensorboard', type=str2bool, default=False)

    # Path
    parser.add_argument('--image_path', type=str, default='../iclevr')
    ...
    parser.add_argument('--wandb-run-name', type=str, default='trail-1-SAGAN')
